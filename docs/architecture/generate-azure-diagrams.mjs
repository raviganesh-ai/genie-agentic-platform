...
function prototypeDiagram() {
  ...
  const content = `
    ...
    ${serviceCard({ x: 765, y: 225, width: 385, height: 90, icon: "containerApps", title: "Prototype frontend Container App", subtitle: ["Dedicated public environment", "Anonymous HTTPS ingress"], accent: colors.green })}
    ...
    ${componentCard({ x: 765, y: 535, width: 385, height: 140, title: "Private VNet + Container Apps environment", subtitle: ["App ingress exposed only inside private VNet", "Private DNS; no public backend route"], accent: colors.orange })}
