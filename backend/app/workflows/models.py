...
class WorkflowStep(BaseModel):
    ...
    variable_sources: dict[str, str] = Field(
        ...
        description=(
            ...
            "resolves to that already-completed step's output_text; and "
            "'step-variable:<step_id>:<variable_name>' resolves to the exact "
            "prompt variable used by that completed step. Any variable "
