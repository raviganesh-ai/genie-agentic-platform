...
- **Named-person Discovery**: the Persona stage lists only real people explicitly named in customer evidence, with each person's role/context, pain points, and evidence references. Role archetypes, teams, organizations, and hypothetical users are rejected; selecting a person focuses the deep dive and clarification flow on that individual's situation. If no person is named, Genie asks for evidence that identifies one instead of inventing a persona.
