...
def test_app_starts_and_reports_ready_for_valid_local_settings(app_local_settings):
...
def test_app_fails_closed_when_required_config_missing(app_local_settings, tmp_path):
    missing = tmp_path / "no-config-here"
    broken = app_local_settings.model_copy(update={"config_root": missing})
